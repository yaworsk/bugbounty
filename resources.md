...
- [Getting a shell environmetn from Runtime.exec](https://codewhitesec.blogspot.com/2015/03/sh-or-getting-shell-environment-from.html)

## Deserialization
- [Deserialization - What Could Go Wrong](https://insomniasec.com/cdn-assets/Deserialization_-__What_Could_Go_Wrong.pdf)

## Email
- [Revisiting Email Spoofing](https://alex.kaskaso.li/post/revisiting-email-spoofing)

## Exfiltration
- [Data Exfiltration via Blind OS Command Injection](https://www.contextis.com/us/blog/data-exfiltration-via-blind-os-command-injection)
